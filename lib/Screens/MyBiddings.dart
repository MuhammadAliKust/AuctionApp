...
class MyBddings extends StatefulWidget {
  const MyBddings({Key key}) : super(key: key);

  @override
  _CreatePostsState createState() => _CreatePostsState();
}

class _CreatePostsState extends State<MyBddings> {
          ...
          child: Column(
            children: [
              ...
              StreamProvider.value(
                value: _postServices.getMyBiddings(userModel.docID),
